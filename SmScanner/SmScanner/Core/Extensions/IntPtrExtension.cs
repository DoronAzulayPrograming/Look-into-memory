...
namespace SmScanner.Core.Extensions
{
    public static class IntPtrExtension
    {
        [Pure]
        [DebuggerStepThrough]
        public static bool CompareTo(this IntPtr ptr, long value)
        {
        ...
        [Pure]
        [DebuggerStepThrough]
        public static IntPtr Add(this IntPtr lhs, int rhs)
        {
        ...
        [Pure]
        [DebuggerStepThrough]
        public static IntPtr Sub(this IntPtr lhs, int rhs)
        {
            return new IntPtr(lhs.ToInt64() - rhs);
        }
        ...
        [Pure]
        [DebuggerStepThrough]
        public static IntPtr Div(this IntPtr lhs, long rhs)
        {
